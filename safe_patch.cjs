const fs = require('fs');
let lines = fs.readFileSync('src/components/LicitacionesRadarView.tsx', 'utf8').split('\n');
...
// Insert the components before export const LicitacionesRadarView...
...
// Find )} before {/* Create Alert Modal */}
const tableEndIndex = lines.findIndex((line, i) => i > gridStartIndex && line.includes(")}"));
